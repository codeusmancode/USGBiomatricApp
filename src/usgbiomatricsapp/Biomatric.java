 ...
 * @author usmanriaz
 */
public class Biomatric extends javax.swing.JFrame {

    /**
     * Creates new form Biomatric
     */
    public Biomatric() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton1.setText("Start Verification");
        ...
        jList1.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "UNIT 1", "UNIT 2", "UNIT 3", "UNIT 5" };
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String ou = jList1.getSelectedValue();
        if (ou == null){
            JOptionPane.showMessageDialog(null, "Please select a unit to proceed.");
            return;
        }
        Global.operatingUnit  = ou;
